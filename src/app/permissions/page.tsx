...
export default function PermissionsScreen() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background relative overflow-hidden p-6">
      ...
      <div className="w-full max-w-lg mx-auto pt-12 pb-10 z-10 animate-in slide-in-from-top-6 fade-in duration-1000">
        <div className="flex items-center gap-4 mb-6">
           <div className="w-12 h-12 ultra-glass border border-foreground/10 rounded-2xl flex items-center justify-center text-primary shadow-2xl animate-pulse">
      ...
      <div className="flex-1 flex flex-col z-10 w-full max-w-lg mx-auto space-y-4 animate-in slide-in-from-bottom-10 fade-in duration-1000 fill-mode-both pb-40">
        {PERMISSIONS.map((perm) => (
          <div key={perm.id} className="ultra-glass border border-foreground/10 rounded-[2rem] p-8 shadow-xl flex gap-6 items-center transition-all hover:bg-foreground/5 hover:border-primary/20 group">
            <div className={cn(
      ...
      <div className="fixed bottom-0 left-0 right-0 p-8 lg:p-12 z-30 pb-16">
        <div className="max-w-lg mx-auto space-y-6">
          <button
            ...
            className="w-full h-20 btn-premium rounded-[2.5rem] font-black text-[11px] uppercase tracking-[0.3em] transition-all shadow-primary/30 active:scale-95 flex items-center justify-center gap-4 group"
          >
